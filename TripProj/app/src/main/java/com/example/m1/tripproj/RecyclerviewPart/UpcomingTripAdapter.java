...
public class UpcomingTripAdapter extends RecyclerView.Adapter <ViewHolder> {
    ...
    public UpcomingTripAdapter(AppCompatActivity activity, ArrayList<Trip> trips) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.tripIcon.setImageResource(R.drawable.plane);
                        ...
                        .setPositiveButton("CONFIRM",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        Log.i("test"," from delete " + trips.get(position).getId());

                                        if(trip.getStatus().equalsIgnoreCase("upcoming")) {
                                            removeAlarm(trips.get(position).getId());
                                        }
